...
int main(int argc, char **argv) {
  // create one pipe for each process,
  // these are used to send the page op requests
  ...
  // create one semaphore for each process,
  // these are used to tell a process when to send a page op request
